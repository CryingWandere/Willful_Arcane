	...
	,	m_container()
{
	...
	loadButton->setText( L"ЗАГРУЗИТЬ ИГРУ" );
	...
	playButton->setText( L"НОВАЯ ИГРА" );
	...
	settingsButton->setText( L"ПАРАМЕТРЫ" );
	...
	creditsButton->setText( L"СОЗДАТЕЛИ" );
	...
	exitButton->setText( L"ВЫЙТИ НА РАБОЧИЙ СТОЛ" );
