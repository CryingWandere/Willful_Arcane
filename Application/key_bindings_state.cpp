	...
	,	m_container()
{
	...
	addButton( Player::MoveForward, 535.f, L"ВВЕРХ", context );
	addButton( Player::MoveBack, 535.f + 70.f, L"ВНИЗ", context );
	addButton( Player::MoveLeft, 535.f + 140.f, L"ВЛЕВО", context );
	addButton( Player::MoveRight, 535.f + 210.f, L"ВПРАВО", context );
	addButton( Player::Attack, 535.f + 280.f, L"АТАКА", context );
	addButton( Player::Interact, 535.f + 350.f, L"ВЗАИМОДЕЙСТВИЕ", context );
	addButton( Player::ChangeScale, 535.f + 420.f, L"ИЗМЕНЕНИЕ МАСШТАБА", context );
