	...
	,	m_container()
{
	...
	continueButton->setText( L"ÏÐÎÄÎËÆÈÒÜ" );
	...
	settingsButton->setText( L"ÍÀÑÒÐÎÉÊÈ" );
	...
	toMainMenuButton->setText( L"ÂÛÉÒÈ Â ÃËÀÂÍÎÅ ÌÅÍÞ" );
	...
	toDesktopButton->setText( L"ÂÛÉÒÈ ÍÀ ÐÀÁÎ×ÈÉ ÑÒÎË" );
	toDesktopButton->setCallback( [ this ]()
	{
		requestStatePush( States::Warning_ETD );
	} );

	auto pauseLabel = std::make_shared< GUI::Label >( L"ÈÃÐÀ ÏÐÈÎÑÒÀÍÎÂËÅÍÀ" , *context.fonts );
