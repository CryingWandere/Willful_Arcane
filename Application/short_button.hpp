...
namespace GUI
{
	...
	class ShortButton : public Component
	{
	public:
		typedef std::shared_ptr< ShortButton > Pointer;
		typedef std::function< void() > Callback;

	public:
		ShortButton( const FontHolder& fonts, const TextureHolder& textures );
	...
	private:
		...
		const sf::Texture& m_lockedTexture;
